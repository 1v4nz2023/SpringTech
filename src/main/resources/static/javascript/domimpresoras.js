...
$(document).ready(function () {
  let urlProducto = `${urlServer}/api/productos/impresoras`;
  ...
  const Dataproductos = async (data) => {
    try {
        ...
        <div class="card col-md-3 col-6 mx-1 my-3 mx-1" style="width: 15rem"> <!-- Cambiar col-md-2 a col-md-3 para mostrar 4 elementos por fila -->
          <a href="impresoras/producto?id=${index.partNumber}"><img src="${index.url}" class="d-block w-100 card-img-top" alt="${index.name}" style="height: 150px;"></a>
      ...
      `;
        var card2Html = `
        <div class="card col-md-3 col-6 mx-1 my-3 mx-1" style="width: 15rem"> <!-- Cambiar col-md-2 a col-md-3 para mostrar 4 elementos por fila -->
          <a href="impresoras/producto?id=${index2.partNumber}"><img src="${index2.url}" class="d-block w-100 card-img-top" alt="${index2.name}" style="height: 150px;"></a>
